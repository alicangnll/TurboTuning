...
int main(int argc, char ** argv) {
    ...
    console::log("\n");
    bool is_turbo = params.turbo_async || 
                    params.cache_type_k == GGML_TYPE_TURBO2_0 || params.cache_type_k == GGML_TYPE_TURBO3_0 || params.cache_type_k == GGML_TYPE_TURBO4_0 ||
                    params.cache_type_v == GGML_TYPE_TURBO2_0 || params.cache_type_v == GGML_TYPE_TURBO3_0 || params.cache_type_v == GGML_TYPE_TURBO4_0;
    if (!is_turbo) {
        console::log("%s\n", LLAMA_ASCII_LOGO);
    }
